...
rec {
  ...
  /* Return an attribute from nested attribute sets.
     ...
     Type: attrByPath :: [String] -> b -> AttrSet -> c
  ...
  */
  ...
  /* Return nested attribute set in which an attribute is set.
     ...
     Type: setAttrByPath :: [String] -> a -> AttrSet
  ...
  */
  ...
  /* Like `attrByPath' without a default value. If it doesn't find the
     ...
     Type: getAttrFromPath :: [string] -> AttrSet -> a
  ...
  */
  ...
  /* Update or set specific paths of an attribute set.
     ...
     Type: updateManyAttrsByPath :: [{ path :: [string], update :: (a -> b) }] -> a -> b
  ...
  */
  ...
  /* Return the specified attributes from a set.
     ...
     Type: attrVals :: [string] -> AttrSet -> [AttrSet] 
  ...
  */
  ...
  /* Given a set of attribute names, return the set of the corresponding
     ...
     Type: getAttrs :: [a] -> AttrSet -> AttrSet
  ...
  */
  ...
  /* Collect each attribute named `attr' from a list of attribute
     ...
     Type: catAttrs :: string -> [AttrSet] -> [a]
  ...
  */
  ...
  /* Filter an attribute set by removing all attributes for which the
     ...
     Type: filterAttrs :: (a -> b -> bool) -> AttrSet -> AttrSet
  ...
  */
  ...
  /* Filter an attribute set recursively by removing all attributes for
     ...
     Type: filterAttrsRecursive :: (a -> b -> bool) -> AttrSet -> AttrSet 
  ...
  */
  ...
  /* Apply fold functions to values grouped by key.
     ...
     Type: foldAttrs :: (a -> b -> [c]) -> [a] -> [AttrSet] -> AttrSet
  ...
  */
  ...
  /* Return the cartesian product of attribute set value combinations.
    ...
    Type: cartesianProductOfSets :: AttrSet -> AttrsSet -> [AttrSet]
  ...
  */
  ...
  /* Utility function that creates a {name, value} pair as expected by
     ...
     Type: nameValuePair :: string -> a -> { name :: string, value :: a }
  ...
  */
  ...
  /* Apply a function to each element in an attribute set.  The
     ...
     Type: mapAttrs :: (name :: string -> value :: any -> any ) -> AttrSet -> AttrSet
  ...
  */
  ...
  /* Like `mapAttrs', but allows the name of each attribute to be
     ...
     Type: mapAttrs' :: (name :: string -> value :: any -> nameValuePair ) -> AttrSet -> AttrSet
  ...
  */
  ...
  /* Generate an attribute set by mapping a function over a list of
     ...
     Type: genAttrs :: [names :: string] -> (a -> b) -> AttrSet 
  ...
  */
  ...
  /* Converts a store path to a fake derivation.
    ...
    Type: toDerivation :: string -> AttrSet
  ...
  */
  ...
  /* Merge sets of attributes and use the function f to merge attributes
     ...
     Type: zipAttrsWithNames :: [a] -> (name :: string -> values :: [b] -> c) -> [AttrSet] -> AttrSet
  ...
  */
  ...
  /* Implementation note: Common names appear multiple times in the list of
     ...
     Type: zipAttrsWith :: (name :: string -> values :: [a] -> b) -> [AttrSet] -> AttrSet
     Example:
  ...
  */
  ...
  /* Does the same as the update operator '//' except that attributes are
     ...
     Type: recursiveUpdateUntil :: (path :: [string] -> lhs :: any -> rhs :: any -> bool) -> AttrSet -> AttrSet -> [AttrSet]
  ...
  */
  ...
  /* Get a package output.
     ...
     Type: getOutput :: string -> AttrSet -> string
  ...
  */
  ...
  /* Pick the outputs of packages to place in buildInputs
    ...
    Type: chooseDevOutputs :: [AttrSet] -> [string]
  ...
  */
  ...
  /* deprecated use zipAttrsWithNames instead

    Type: zipWithNames :: [a] -> (name :: string -> values :: [b] -> c) -> [AttrSet] -> AttrSet
  
  */
  zipWithNames = zipAttrsWithNames;

  /* deprecated use zipAttrsWith instead

    Type: zip :: (name :: string -> values :: [a] -> b) -> [AttrSet] -> AttrSet
